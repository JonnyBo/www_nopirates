...
?>
    ...
    <?if(Yii::$app->session->hasFlash('created')):?>
        <div class="successMessage">
            <p>Проект &laquo; <?=Yii::$app->session->getFlash('created')->name; ?>&raquo; создан.</p>
        </div>
    <?endif;?>
            <?if(Yii::$app->session->hasFlash('deleted')):?>
                <div class="successMessage">
                    <p>Проект &laquo;
                        <?=Yii::$app->session->getFlash('deleted')->name?>&raquo; удален.</p>
                </div>
            <?endif;?>
                    ...
                    <div>
                        <?= Html::a('Добавить проект', ['socials/create'], ['class' => 'project-link']) ?>
                    </div>
                    <?
$columns = array(
